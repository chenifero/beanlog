...
import { IoStatsChart, IoSettings, IoChevronBack, IoChevronForward } from 'react-icons/io5'
  ...
  return (
    ...
    <aside className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <div className="sidebar-header">
        ...
        {!isCollapsed && (
          <img src="logos/logo_header_slogan.png" alt="BeanLog" className="sidebar-logo-img" />
        )}
        {/* Botón que alterna entre expandido y colapsado */}
        <button className="sidebar-toggle" onClick={toggle} title={isCollapsed ? 'Expandir' : 'Colapsar'}>
