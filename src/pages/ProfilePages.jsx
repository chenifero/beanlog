...
import SavedPostsModal from "@/components/social/SavedPostsModal";
...
export default function ProfilePage() {
  ...
  return (
    <div className="profile-page">
      ...
      {showSaved && <SavedPostsModal onClose={() => setShowSaved(false)} />}
